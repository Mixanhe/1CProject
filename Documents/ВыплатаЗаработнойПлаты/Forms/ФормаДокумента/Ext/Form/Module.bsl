...
Процедура ВыплатитьВсемФиксированнуюСуммуПриИзменении(Элемент)
	...
	Если ВыплатитьВсемФиксированнуюСумму = Истина Тогда
		Элементы.ВыдатьПолннуСуммуЗарплаты.Доступность = Ложь;
		Элементы.ВыплатитьВсемТолькоОклад.Доступность = Ложь;
		Элементы.ВыплатитьПоловинуЗарплаты.Доступность = Ложь;
		Элементы.ФиксированнаяСумма.Видимость = Истина;
		Элементы.ПроизвестиВыплату.Видимость = Истина;
		
	Иначе
		Элементы.ВыдатьПолннуСуммуЗарплаты.Доступность = Истина;
		Элементы.ВыплатитьВсемТолькоОклад.Доступность = Истина;
		Элементы.ВыплатитьПоловинуЗарплаты.Доступность = Истина;
		Элементы.ФиксированнаяСумма.Видимость = Ложь;
		Элементы.ПроизвестиВыплату.Видимость = Ложь;
		
	КонецЕсли;
	
	ВыплатитьВсемФиксированнуюСуммуПриИзмененииНаСервере();
КонецПроцедуры
